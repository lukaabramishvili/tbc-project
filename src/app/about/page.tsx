...
export default function About() {
  ...
  return (
    <section className="bg-white dark:bg-[#2C2758] text-gray-900 dark:text-white py-16 px-6 sm:px-12 lg:px-24 max-h-[calc(100vh-13.5rem)]">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-lg leading-relaxed">
          {language === "eng" ? "Welcome to" : "კეთილი იყოს თქვენი მობრძანება"}{" "}
