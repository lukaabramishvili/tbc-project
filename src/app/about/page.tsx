...
export default function About() {
  ...
  return (
<section className="bg-white dark:bg-[#2C2758] text-gray-900 dark:text-white pt-8 pb-16 px-6 sm:px-12 lg:px-24 max-h-[calc(100vh-13.125rem)] xl:max-h-[calc(100vh-13.5rem)]">
